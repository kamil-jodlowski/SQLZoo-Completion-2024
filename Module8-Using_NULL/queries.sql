...
/* Query 6: Use the COALESCE function and a LEFT JOIN to print the teacher name and department name. 
...
/* Query 8: Use COUNT and GROUP BY dept.name to show each department and the number of staff. 
...
/* Query 10: Use CASE to show the name of each teacher followed by 'Sci' if the teacher is in 
