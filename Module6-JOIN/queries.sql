...
/* Query 2: From the previous query you can see that Lars Bender's scored a goal in game 1012. 
...
/* Query 3: You can combine the two steps into a single query with a JOIN.
...
/* Query 4: Use the same JOIN as in the previous question.
...
/* Query 5: The table eteam gives details of every national team including the coach. 
...
/* Query 6: To JOIN game with eteam you could use either
...
/* Query 8: The example query shows all goals scored in the Germany-Greece quarterfinal.
...
/* Query 12: For every match involving 'POL', show the matchid, date and the number of goals scored.*/
...
/* Query 13: List every match with the goals scored by each team as shown. 
