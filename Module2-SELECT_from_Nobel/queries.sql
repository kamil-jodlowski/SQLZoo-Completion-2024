...
/* Query 3: Give the name and the per capita GDP for those countries with a 
...
/* Query 7: Two ways to be big: A country is big if it
has an area of more than 3 million sq km or it has a population of more than 250 million.
...
/* Query 8: Exclusive OR (XOR). Show the countries that are big by area (more than 3 million) 
...
SELECT name, ROUND(population/1000000, 2) AS Populationn, ROUND(gdp/1000000000, 2) AS Gdpp
FROM world
WHERE continent = 'South America';

/* Query 10: Show the name and per-capita GDP for those countries with a GDP of at least one trillion (1000000000000; 
that is 12 zeros). 
